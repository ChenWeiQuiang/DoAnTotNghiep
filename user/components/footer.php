            ...
            <div class="row">
                <div class="col-xl-4 col-md-3">
                    <div class="footer-widget mb-40">
                        <h3 class="footer-widget-title">Dịch vụ khách hàng</h3>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="footer-widget mb-40">
                        ...
                        <div class="footer-newsletter">
                            <p>Mọi thông tin chi tiết xin vui lòng liên hệ sđt: <b>0365116581</b></p>
                            ...
                            <div class="footer-contact">
                                <p><span><i class="ti-location-pin"></i></span>77 Nguyên Xá, Minh Khai, Bắc Từ Niêm, Hà Nội</p>
                                <p><span><i class=" ti-headphone-alt "></i></span> +365116581</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="copyright">
                        <p>
                            Copyright ©
                            <a href="#">Tran Duy Khuong</a> 2022 . All Right Reserved.
                        </p>
                    </div>
                </div>
            </div>
